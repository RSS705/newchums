...
import mtgResultsHtml from "./templates/mtgResults.html";
import mtgResultsTxt from "./templates/mtgResults.txt";
...
const TEMPLATES: Record<string, TemplatePair> = {
  ...
  mtgResults: { html: mtgResultsHtml, text: mtgResultsTxt },
