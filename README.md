...
- **Tags**: after a plan, attendees tag each other from a fixed catalogue of 79 (Good Energy, Quick Wit, Salt Miner, Topdeck Hero, Group MVP…), anonymous, three per giver per plan, collected as counts on public profiles. Internally the feature is still called kudos.
