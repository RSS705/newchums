...
| `share_sheet_opened` | Native share sheet invoked from the share moment (`navigator.share`, only rendered where the device supports it). | `surface` (`post_publish` \| `plan_page`) | GA |
