...
- Preference key `mtg_challenge` ("MTG Prediction Challenge", default on) in `notificationPrefs.ts`, the settings list and the unsubscribe page labels.
