...
- **Tags (kudos internally):** After a plan, attendees tag each other from a fixed 79-tag catalogue (anonymous, three per giver per plan, 7-day window); counts collect on public profiles. Replaced text shout-outs in Sept 2026.
