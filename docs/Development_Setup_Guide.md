...
- **Kudos:** After a plan, attendees give each other fixed-tag kudos (anonymous, three per giver per plan, 7-day window); counts collect on public profiles. Replaced text shout-outs in Sept 2026.
