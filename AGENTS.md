...
| **24-hour attendance check** | Fully implemented. User-facing name: "24-hour attendance check". Host-configurable confirmation window, reminders, cutoff processing, fallback policies (proceed/notify host/auto-cancel), in-app and email confirmation flows. Migrations 028, 039. Cron-based lifecycle. Internal field: `require_reconfirmation`. | Operational. Use "24-hour attendance check" in all user-facing copy. Polish and enhance as needed. |
